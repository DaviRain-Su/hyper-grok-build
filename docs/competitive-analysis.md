...
| A13 | 扩展工作流**不改核心**即可分享 | Pi packages | plugins/skills + **WASM Extension Bus** | 横向 | **building**（Phase 1） | [design-wasm-extensions.md](./design-wasm-extensions.md)；discovery+session pre_tool；示例 safe-shell-wasm |
