...
| A6 | 一键知道仓库**适不适合自治** | Droid Readiness | `/readiness` 或 doctor 扩展 | P2 | idea | build/test/AGENTS |
...
| A13 | 扩展工作流**不改核心**即可分享 | Pi packages | plugins/skills 打包体验 | 横向 | idea | 示例与文档 |
