...
mod tests {
    ...
    const ALL_KEYS: &[&str] = &[
        ...
        "changes.empty",
        "changes.no_patch",
        "changes.confirm_reject_all",
        "changes.footer.accept_hunk",
        "changes.footer.reject_hunk",
        "changes.footer.accept_file",
        "changes.footer.reject_file",
        "changes.footer.accept_all",
        "changes.footer.reject_all",
        "changes.footer.refresh",
        "changes.source.agent_turn",
        "changes.source.external_on_agent",
        "changes.source.external",
        "changes.confirm_reject",
        "changes.confirm_reject_external",
        "changes.source.unknown",
        "changes.stale_noop",
