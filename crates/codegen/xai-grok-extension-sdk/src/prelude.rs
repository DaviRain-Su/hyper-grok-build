...
pub use crate::{
    ...
    log_error, log_info, log_warn, plugin_data_dir, prompt, stop_hook_active, tool_index,
    tool_input_json, tool_name, tool_result, CORE_ABI_VERSION, EMPTY_OBJECT_SCHEMA, LOG_DEBUG,
