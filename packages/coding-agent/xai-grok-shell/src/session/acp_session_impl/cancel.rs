...
<<<<<<<< HEAD:packages/coding-agent/xai-grok-shell/src/session/acp_session_impl/tasks_cancel.rs
...
========
>>>>>>>> upstream/main:packages/coding-agent/xai-grok-shell/src/session/acp_session_impl/cancel.rs
