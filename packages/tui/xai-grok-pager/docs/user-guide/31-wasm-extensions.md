...
let data = plugin_data_dir(); // may be empty in bare tests
```
...
- SDK: `packages/extensions/xai-grok-extension-sdk/`
- Proc macros: `packages/extensions/xai-grok-extension-macros/`
