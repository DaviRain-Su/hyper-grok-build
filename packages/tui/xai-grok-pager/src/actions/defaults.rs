...
pub(super) fn default_actions(
    ...
    let mut actions = vec![
        ...
        ActionDef {
            ...
            requires_confirmation: false,
            long_help: Some(
                "Cycles forward through the scoped model shortlist ([models].enabled_models).\nWhen the shortlist is empty, cycles all usable models.\nEdit the shortlist with /scoped-models. Full picker remains Ctrl+M / /model.\nBound to Alt+] (Alt+[ for previous).",
            ),
        },
        ActionDef {
            id: ActionId::PrevModel,
            label: "prev model",
            ...
            requires_confirmation: false,
            long_help: Some(
                "Cycles backward through the scoped model shortlist ([models].enabled_models).\nWhen the shortlist is empty, cycles all usable models.\nBound to Alt+[ (Alt+] for next).",
            ),
        },
        ActionDef {
