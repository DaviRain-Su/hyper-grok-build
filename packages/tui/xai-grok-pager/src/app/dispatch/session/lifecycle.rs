...
/// Create a session on an existing unbound agent without opening a project
/// picker (picker removed upstream). Used by Live / voice cold-start when
/// the agent has no ACP session yet.
